...
insert  into `AutoSales_Schema`.`offices`(`officeCode`,`city`,`phone`,`addressLine1`,`addressLine2`,`state`,`country`,`postalCode`,`territory`) values 
...
insert  into `AutoSales_Schema`.`employees`(`employeeNumber`,`lastName`,`firstName`,`extension`,`email`,`officeCode`,`reportsTo`,`jobTitle`) values 
...
insert  into `AutoSales_Schema`.`customers`(`customerNumber`,`customerName`,`contactLastName`,`contactFirstName`,`phone`,`addressLine1`,`addressLine2`,`city`,`state`,`postalCode`,`country`,`salesRepEmployeeNumber`,`creditLimit`) values 
...
insert  into `AutoSales_Schema`.`payments`(`customerNumber`,`checkNumber`,`paymentDate`,`amount`) values 
...
insert  into `AutoSales_Schema`.`productlines`(`productLine`,`textDescription`,`htmlDescription`,`image`) values 
...
insert  into `AutoSales_Schema`.`products`(`productCode`,`productName`,`productLine`,`productScale`,`productVendor`,`productDescription`,`quantityInStock`,`buyPrice`,`MSRP`) values 
...
insert  into `AutoSales_Schema`.`orders`(`orderNumber`,`orderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`customerNumber`) values 
...
insert  into `AutoSales_Schema`.`orderdetails`(`orderNumber`,`productCode`,`quantityOrdered`,`priceEach`,`orderLineNumber`) values 
